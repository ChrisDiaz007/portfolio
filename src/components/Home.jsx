...
const skills = [
  {
    ...
    badges: [
      ...
      "https://img.shields.io/badge/Stimulus-333333?style=for-the-badge&logo=stimulus&logoColor=white",
  ...
  },
  {
    category: "Tools",
    badges: [
      "https://img.shields.io/badge/RESTful%20API-6DB33F?style=for-the-badge&logo=springboot&logoColor=white",
          ...
          <div className="border-l-18 flex flex-col pl-7 border-l-fuchsia-500 font-bold text-fuchsia-400">
            {skills.map((skill, i) => (
              <div key={i} className="skill card">
                <div className="text-[28px]">{skill.category}</div>
